...
class Consumer extends events_1.EventEmitter {
    ...
    executeHandler(message) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.pendingMessages = utils_1.filterOutByGroupId(this.pendingMessages, (_a = message.Attributes) === null || _a === void 0 ? void 0 : _a.MessageGroupId);
                throw err;
            }
            finally {
    ...
    startHeartbeat() {
        this.heartbeatTimeout = setInterval(() => __awaiter(this, void 0, void 0, function* () {
            const now = Date.now();
            const messages = utils_1.groupMessageBatchByArrivedTime(this.pendingMessages);
            for (const msg of messages) {
                const elapsedSeconds = Math.ceil((now - msg[0].arrivedAt) / 1000);
                yield this.changeVisibilityTimeoutBatch(msg.map((a) => a.sqsMessage), elapsedSeconds + (this.visibilityTimeout || 0));
            }
