...
exports.toSQSError = exports.isConnectionError = exports.createTimeout = exports.isPollingReadyForNextReceive = exports.groupMessageBatchByArrivedTime = exports.filterOutByGroupId = exports.getNextPendingMessage = void 0;
...
exports.filterOutByGroupId = (pendingMessages, groupId) => {
    return pendingMessages.filter((e) => { var _a; return ((_a = e.sqsMessage.Attributes) === null || _a === void 0 ? void 0 : _a.MessageGroupId) !== groupId; });
};
