...
exports.removeMessagesFromPending = exports.isFifo = exports.toSQSError = exports.isConnectionError = exports.createTimeout = exports.isPollingReadyForNextReceive = exports.groupMessageBatchByGroupId = exports.groupMessageBatchByArrivedTime = exports.getMessagesByGroupId = exports.filterOutByGroupId = exports.getNextPendingMessageBatch = exports.getNextPendingMessage = void 0;
 ...
 */
exports.getNextPendingMessageBatch = (batch) => {
    const [batchToProcess] = exports.groupMessageBatchByGroupId(batch.filter((m) => !m.processing));
...
exports.groupMessageBatchByGroupId = (batch) => {
    return [...new Set(batch.map((w) => { var _a; return (_a = w.sqsMessage.Attributes) === null || _a === void 0 ? void 0 : _a.MessageGroupId; }))].map((groupId) => {
        return batch.filter((w) => { var _a; return ((_a = w.sqsMessage.Attributes) === null || _a === void 0 ? void 0 : _a.MessageGroupId) === groupId; });
    });
};
...
exports.removeMessagesFromPending = (pendingMessages, messages) => {
